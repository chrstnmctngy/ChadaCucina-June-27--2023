...
<body>
    <header class="header" id="header">
      ...
      <main class="main">
        ...
        <h2 class="recipe-title">Chicken Tinola Recipe</h2>
      </section>

      <section>
          <div class="pic-rcp">
          <div class="pic-slider">
            <img src="./assets/images/recipe/tinola.png" alt="Image1" class="pic">
          </div>
        </div>
    </section>
    ...
    <section class="serve-container">
        ...
        <div class="serve-card">
            ...
            <p class="recipe-subtitle1">20 mins</p>
        </div>
        <div class="serve-card">
    ...
    <section class="ingredient-container">
            ...
            <div class="column right-column">
                ...
                <ol class="ingredient-text">
                    <li>Step 1</li>
                        <p>Get a pot and bring it up to medium heat before pouring in the oil. Drop in the onions, garlic and ginger and sauté slowly for about 2 minutes or until you can smell the lovely aroma.</p>
                    <li>Step 2</li>
                        <p>It’s time to drop in the chicken pieces and stir until it turns white or light brown in color.</p>
                    <li>Step 3</li>
                        <p>Pour in the water and add your Knorr Chicken Broth cubes. Bring this to a simmer until chicken is tender and cooked through.</p>
                    <li>Step 4</li>
                        <p>You can now add your sayote or green papaya and cook until tender.</p>
                    <li>Step 5</li>
                        <p>Dahon ng sili is added at the last stage to ensure leaves (and nutrients) don’t dry up. Give this a minute then it is done. Malunggay is also another healthy alternative because it is packed with vitamins and minerals which are good for nursing moms and kids as well.</p>
                    <li>Step 6</li>
                        <p>Enjoy this with patis and calamansi on the side. See the faces of your whole family light up as you bring this to the table.</p>
                </ol>
            </div>
    </section>
    <section>
